...
class NotificationDatasource {
  ...
  /// Conecta no endpoint SSE (/notifications/events) e emite cada evento
  /// recebido. Reconecta automaticamente com backoff exponencial em caso
  /// de queda de conexão, igual ao app cliente.
